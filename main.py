...
def get_gemini_response(user_text):
    try:
        # تغییر به مدل Pro که سازگاری بسیار بالایی دارد
        # استفاده از ورژن v1 به جای v1beta برای پایداری
        ...
        print("--- Connecting to Gemini Pro (v1) ---", flush=True)
        ...
        if response.status_code == 200:
            ...
            print(f"!!! Google Error: {error_msg}", flush=True)
...
def bot_loop():
    last_update_id = 0
    print("--- ربات با مدل Pro فعال شد ---", flush=True)
